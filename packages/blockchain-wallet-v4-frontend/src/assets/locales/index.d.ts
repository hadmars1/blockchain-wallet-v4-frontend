...
type MessagesType = {
  ...
  'buttons.buy_sell_now': '{orderType} Now'
  'buttons.buy': 'Buy'
  'buttons.go': 'Go'
  ...
  'components.alerts.iprestriction_login_error': 'This account is restricted to another IP address. To remove this restriction, submit a 2FA reset request under '
  ...
  'components.alerts.mobile_login_error': 'Error logging into your account'
  ...
  'components.alerts.new_wallet_create_error': 'Failed to create new account'
  'components.alerts.new_wallet_create_success': 'Successfully created new account'
  ...
  'components.alerts.please_login': 'Please login to your account to proceed'
  ...
  'components.alerts.register_error': 'Account could not be created'
  'components.alerts.register_successful': 'Account successfully created'
  ...
  'components.alerts.restore_error': 'Error restoring your account'
  'components.alerts.restore_success': 'Your account has been successfully restored'
  'components.alerts.restore_wallet_info': 'Restoring account...'
  ...
  'components.alerts.verify_device_failed': 'Failed to verify device.'
  ...
  'components.alerts.wallet_upgrade_error': 'Failed to upgrade and save account.'
  ...
  'copy.bank_linked.name': 'Your {bankName} account is now linked to your Blockchain.com Account'
  ...
  'copy.email': 'Email'
  'copy.enter_new_password': 'Enter New Password'
  'copy.confirm_new_password': 'Confirm New Password'
  'copy.exchage': 'Exchange'
  ...
  'copy.swap_upgrade.more_crypto': 'Swap More Crypto'
  ...
  'copy.upgrade_your_wallet': 'Upgrade Your Account'
  ...
  'identityverification.highflow.scanqr': '1 - <b>Scan this QR code</b> with your phone to log into this account or download our mobile app.'
  ...
  'layouts.wallet.menuleft.navigation.earninterest': 'Earn Rewards'
  ...
  'modals.brokerage.updating_your_wallet': 'Updating Your Account...'
  ...
  'modals.brokerage.withdraw_holding_period': 'Newly added funds are subject to a holding period. You can transfer between your Trading, Rewards, and Exchange accounts in the meantime.'
  ...
  'modals.brokerage.bank_deposit_description': 'Securely link a bank and send cash to your Blockchain.com Account at anytime.'
  ...
  'modals.autodisconnection.foryoursafety1': "You've been inactive for {duration} minutes. For your safety, you'll be logged out of your Account shortly."
  ...
  'modals.interest.deposit.calc': 'Rewards Calculator'
  'modals.interest.deposit.calcdesc': 'With {currencySymbol} {depositAmountFiat} in your Rewards Account you can earn:'
  'modals.interest.deposit.calcdesccoin': 'With {depositAmount} {coinTicker} in your Rewards Account you can earn:'
  ...
  'modals.interest.deposit.calcrate': 'Estimates based on current rewards rate and {coinTicker} price.'
  'modals.interest.deposit.calculator.tooltip': 'This is an estimate calculated using the current rewards rate for the entire horizon. The actual rewards rate is subject to change.'
  'modals.interest.deposit.agreement.custodial1': 'By accepting this, you agree to transfer {depositAmountFiat} ({depositAmountCrypto}) from your {displayName} Trading Account to your Rewards Account. An initial hold period of {lockupPeriod} days will be applied to your funds.'
  ...
  'modals.interest.deposit.subheader_transfer': 'Transfer {displayName} to your Rewards Account and earn up to {rate}% in rewards annually on your crypto.'
  'modals.interest.deposit.success.confirmtransfer': 'Waiting on your transfer to be confirmed by the network. Once it has a confirmation and our team has reviewed it, it will be displayed in your Rewards Account history. No action is required at this time.'
  'modals.interest.deposit.youcantransfer': 'You can transfer up to'
  'modals.interest.deposit.transferclears': 'Once the transfer clears, your balance will update and you’ll start earning rewards.'
  'modals.interest.deposit.confirms': 'You will see your deposit in your Rewards Account history when the transaction has at least one confirmation.'
  'modals.interest.deposit.title_transfer': 'Transfer {displayName}'
  'modals.interest.detailsbalance': '{coin} Balance'
  'modals.interest.detailstitle': '{displayName} Rewards Account'
  'modals.interest.earninterest': 'of {displayName} to your Savings Wallet and earn 3% in rewards.'
  ...
  'modals.interest.deposit.sendingsubtitle': 'Sending {displayName} to your Rewards Account'
  'modals.interest.deposit.sendingtitle': 'In Progress...'
  'modals.interest.moredetails.tooltip.description': 'Rewards accrues daily and is paid monthly. The rewards rate may be periodically adjusted.'
  'modals.interest.status': 'Status'
  'modals.interest.statuspending': 'Pending {action}'
  'modals.interest.summary': 'Summary'
  'modals.interest.summary.accrued': 'Accrued rewards this month'
  'modals.interest.summary.accrued.tooltip.description': 'Rewards earned month to date. Total rewards earned during any month will be deposited on the 1st of the following month.'
  ...
  'modals.interest.summary.next': 'Next rewards payment'
  'modals.interest.summary.rate': 'Rewards rate'
  ...
  'modals.interest.deposit.supply_information_description_2': 'Your funds are safe with us and have started accruing rewards already. To avoid delays when you decide to withdraw your funds, submit your information now.'
  'modals.interest.totalearned': 'Total Rewards Earned'
  'modals.interest.symbolearned': '{symbol} Rewards Earned'
  'modals.interest.unsupported-title': 'Rates Unavailable'
  'modals.interest.unsupported-subcontent-1': "Rewards rates are currently unavailable for {walletCurrency}. Please change your wallet's local currency in Preferences."
  ...
  'modals.interest.withdrawal.recap': 'You are requesting to withdraw <b>{withdrawalAmountFiat}</b> ({withdrawalAmountCrypto}) from your Rewards Account. After confirming this withdrawal, you will not continue to earn rewards on the amount withdrawn.'
  'modals.interest.withdrawal.progress': 'In Progress'
  'modals.interest.withdrawal.progressmsg': 'Requesting a withdrawal from your Rewards Account'
  ...
  'modals.onboarding.linkfromexchange.success_info2': 'You are now {status} with Blockchain.com, allowing you to swap, buy & sell, and earn rewards.'
  ...
  'modals.send.banner.description': 'Verify your ID now and unlock Gold level trading. Send up to {dayCurrencySymbol}{dayAmount} a {suggestedPeriod}. Now, your limit is {currency}{limit} a {period}.'
  ...
  'modals.simplebuy.summary.ach_lock': 'Note: You will not be able to Send or Withdraw these funds from your Account for the next {days} days.'
  ...
  'modals.simplebuy.summary.disclaimer': 'You will not be able to Send or Withdraw these funds from your Account for the next 1 day.'
  'modals.simplebuy.summary.disclaimer_plural': 'You will not be able to Send or Withdraw these funds from your Account for the next {days} days.'
  ...
  'modals.swap.cross_border_max': 'Swapping from Trade Accounts cannot exceed {amount} a {period}. You have {remainingAmount} remaining.'
  ...
  'modals.limits_and_features.subtitle.silver': 'Unlock new trading features in your Blockchain.com Account by verifying your ID and linked a bank or card.'
  ...
  'modals.tradinglimits.description': 'Unlock features within your Blockchain.com Account. Some features may ask you to verify your identity.'
  ...
  'modals.tradinglimits.upgrade.tier.silver.description': 'Verify your ID and link your bank to Buy & Sell Crypto straight from your account.'
  'modals.tradinglimits.upgrade.silver_limits': 'Silver Limits'
  'modals.tradinglimits.upgrade.gold_limits': 'Gold Limits'
  'modals.tradinglimits.upgrade.unlock_tier_zero': 'Unlock new trading features in your Blockchain.com Account by verifying your ID and link a bank or card.'
  ...
  'modals.upgradenow.gold_details': 'Connect your bank or card to your Account. Hold cash in your wallet. Earn crypto with Rewards.'
  ...
  'modals.twostepsetup.explain': 'Protect your account from unauthorized access by enabling 2-step Setup.'
  'modals.twostepsetup.explain2': 'You can choose to use a free app or your mobile phone number to secure your account.'
  ...
  'scenes.authorizelogin.attemptfrombrowsermsg': 'Someone, hopefully you, is attempting to login to your account from a different browser.'
  ...
  'scenes.borrow.subheader': 'Blockchain.com lets you borrow USD Digital from your Blockchain Account with crypto as collateral.'
  ...
  'scenes.borrow.transferterms.read3': 'collateral will be returned after your loan has been repaid minus any accrued rewards and fees.'
  ...
  'scenes.help.2fa.lostexplain': 'Reset your 2FA right now to gain access to your Account.'
  ...
  'scenes.home.banners.interestpromo.title': 'Limited Time: Earn up to 12% annual rewards'
  'scenes.home.banners.interestpromo.subtitle': 'Deposit crypto in an Rewards Account by midnight on Wednesday to supercharge your rewards on BTC, ETH, USDT, and PAX.'
  ...
  'scenes.interest.earninfo.verified.copy': 'Earn up to {highestRate}% annually when you transfer crypto to your Rewards Account.'
  'scenes.interest.earnheaderverified': 'Earn rewards on your crypto today.'
  'scenes.interest.earnupgrade.header': 'Upgrade to Gold Level so you can earn rewards on your crypto.'
  'scenes.interest.history.filter': 'Filter by:'
  'scenes.interest.history.header': 'History'
  'scenes.interest.history.type': 'Type'
  'scenes.interest.history.empty.here': 'All your Rewards transactions will show up here.'
  'scenes.interest.interestaccount': 'Rewards Account'
  ...
  'scenes.interest.regionblocked': 'Blockchain Rewards Account is currently not available in your country or region for some or all cryptos.'
  'scenes.interest.userblocked.bo': 'Blockchain Rewards Account is currently not available.'
  ...
  'scenes.interest.summarycard.tooltip': 'The rate is subject to change. Rewards rate will be paid in {coin}.'
  'scenes.interest.summarycard.totalinterest': 'Total Rewards Earned'
  'scenes.interest.summarycard.earnbutton': 'Earn Rewards'
  ...
  'scenes.interest.subheader': 'Deposit crypto and watch it grow. Rewards are paid by the end of the day on the 1st of each month.'
  ...
  'scenes.lockbox.settings.removedevice.description': 'Remove {deviceName} from your Blockchain account'
  ...
  'scenes.login.verify_device.header': 'Login attempt from another browser or device'
  'scenes.login.verify_device.copy': 'We noticed a login attempt recently from a different browser or device. If this was you, verify the login device.'
  ...
  'scenes.login.productpicker.wallet': 'Easily buy and sell Bitcoin, Ether and more.'
  'scenes.login.productpicker.exchange': 'Advanced trading with USD, GBP & EUR pairs.'
  'scenes.login.productpicker.explorer': 'Data analytics for BTC, ETH and more.'
  ...
  'scenes.preferences.autologout.description': 'After a certain period of inactivity, you will be automatically logged out of your account.'
  ...
  'scenes.recover.firststep.mnemonic_explain_verification': 'For your security, you may have to re-verify your identity before accessing your Trading or Rewards accounts.'
  ...
  'scenes.recovery.resetting': 'Resetting will restore your Trading, Rewards, and Exchange accounts.'
  'scenes.recovery.reverify': 'For your security, you may have to re-verify your identity before accessing your trading or rewards account.'
  ...
  'scenes.reset2fa.firststep.explain': 'Fill out the form below to regain access to your account by resetting your 2FA, restricted IP, and verified email.'
  ...
  'scenes.reset2fa.firststep.firststepform.emailexplain': "Enter the email associated with your account (even if you've lost access to it)."
  ...
  'scenes.reset2fa.firststep.newEmailExplain': "Enter your updated email if you've lost access to your previously verified email. If your 2FA reset request is approved, this will automatically be set as your account's new email address."
  ...
  'scenes.security.email.changeemail.description': "This will change your account's email address. The email address you use to buy or sell with will remain the same."
  ...
  'scenes.security.email.unverifiedemaildescription': 'We have sent a verification email to <b>{email}</b>. Please click on the email that you’ve received to verify your email. We’ll use this email to authorize logins, send payment notifications, and notify you of account updates.'
  'scenes.security.email.upateform.changetext': 'Change Your Email'
  'scenes.security.email.verifieddescription.success': 'You’ve verified <b>{email}</b>. Select "Change Email" to modify this existing address. We will use this email to authorize logins, send payment notifications, and notify you of account updates.'
  ...
  'scenes.security.twostepverification.description2': 'Two-step verification helps to prevent unauthorized access to your account by requiring a one-time password for every login attempt. Enable this to further secure your account.'
  'scenes.security.twostepverification.description3': 'Two-step verification helps to prevent unauthorized access to your account by requiring a one-time password for every login attempt. You can disable this here if you would like to change your phone number or switch the type of two-step verification you are using.'
  'scenes.security.twostepverification.error.description': 'Use an Authenticator app, Yubikey, or SMS Codes'
  'scenes.security.twostepverification.error.description2': 'Two-step verification helps to prevent unauthorized access to your account by requiring a one-time password for every login attempt. Enable this to further secure your account.'
  ...
  'scenes.security.twostepverification.loading.description2': 'Two-step verification helps to prevent unauthorized access to your account by requiring a one-time password for every login attempt. Enable this to further secure your account.'
  ...
  'scenes.securitycenter.2fa.tip': 'You can choose to use a free app or your mobile phone number to secure your account. We recommend using Google Authenticator (available for'
  ...
  'scenes.securitycenter.advanced.loginiprestriction.description.part2': 'If you do not have a static IP address, this may lock you out of your account.'
  ...
  'scenes.securitycenter.advanced.passwordstretching.description': 'This increases the difficulty of discovering your password using a brute-force attack but slows down loading and saving your account.'
  ...
  'scenes.securitycenter.introtextfour': 'Congratulations, you have completed the initial steps in helping to prevent unauthorized access to your account and bringing you even closer to financial security. Remember to always use caution with where you store your account details, what information you share with others, and with phishing emails.'
  'scenes.securitycenter.introtextnone': 'Welcome to your Security Center! Complete the following three steps to help prevent unauthorized access to your account and ensure you can access your funds at any time.'
  ...
  'scenes.settings.addresses.btc.archivedaddresses.description': 'Archived addresses are addresses you may not need anymore that are hidden from the main view but still a part of your account. You can unarchive them any time.'
  'scenes.settings.addresses.btc.archivedaddresses.title': 'Archived Bitcoin Addresses'
  'scenes.settings.addresses.btc.failurealert': 'There is an issue with the account and this page may have limited functionality, such as balances not showing.'
  ...
  'scenes.settings.general.walletid.description': 'Wallet ID is your unique identifier. It is completely individual to you, and it is what you will use to log in and access your account. It is NOT a bitcoin address for sending or receiving.'
  ...
  'scenes.settings.preferences.mobile.error.description2': 'helping to secure your account from unauthorized access,'
  ...
  'scenes.settings.preferences.mobile.loading.description2': 'helping to secure your account from unauthorized access,'
  ...
  'scenes.settings.preferences.mobile.success.description2': 'helping to secure your account from unauthorized access,'
  ...
  'scenes.settings.preferences.walletlanguage.success.title': 'Account Language'
  ...
  'scenes.settings.tor.description2': 'The Tor network is frequently used by hackers attempting to access Blockchain users accounts.'
  'scenes.settings.tor.title': 'Account Access via Tor'
  ...
  'scenes.transaction.interest.view_txs': 'Visit the Earn Rewards page to view your transaction history.'
  ...
  'scenes.verifyemailtoken.return_mobile': 'Return to the app to access your Blockchain.com Account.'
  'scenes.verifyemailtoken.return': 'Return to the previous tab to access your Blockchain.com Account.'
