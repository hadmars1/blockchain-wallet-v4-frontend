...
export default ({ api, coreSagas, networks }) => {
  ...
  return function* simpleBuySaga() {
    ...
    yield takeLatest(actions.fetchCard.type, simpleBuySagas.fetchCard)
    yield takeLatest(actions.fetchCards.type, simpleBuySagas.fetchCards)
    yield takeLatest(actions.fetchFiatEligible.type, simpleBuySagas.fetchFiatEligible)
