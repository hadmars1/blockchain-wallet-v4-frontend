  ...
  return {
    ...
    headers: {
      ...
      'Content-Security-Policy': [
        `img-src 'self' *.googleusercontent.com *.zendesk.com *.yapily.com https://storage.opensea.io https://raw.githubusercontent.com https://login.blockchain.com data: blob:`,
        allowUnsafeScripts
